                  ...
                  <div className="mt-1 text-sm text-[#023047]/70">
                    ...
                    <ul className="text-left text-xs md:text-sm mt-2 ml-4 list-disc space-y-1">
                      ...
                      <li>
                        ...
                        <a href={BACKUP_DOC_URL} target="_blank" rel="noopener noreferrer" className="text-[#219EBC] underline hover:text-[#023047]">tts-api-docs.chloemlla.com</a>
                ...
                <m.div ref={dialogRef}
                  ...
                  <div className="flex flex-col gap-3 mb-4">
                    ...
                    <m.button onClick={() => confirmRedirect(BACKUP_DOC_URL)}
                      ...
                      <span className="truncate">{lang === 'zh' ? '备用站点：951100.xyz' : 'Backup: chloemlla.com'}</span>
