  ...
  return (
    ...
    >
      <div className="flex-grow flex justify-center items-center p-4 sm:p-6 md:p-8 lg:p-10">
        ...
        >
          <div className="w-full bg-white/90 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-center text-blue-500 mb-4 sm:mb-6 flex items-center justify-center gap-2 transition-all duration-200 hover:scale-105 hover:-translate-y-1 cursor-pointer">
              <i className="fas fa-volume-up" /> Happy 文本转语音服务条款与隐私政策
            </h1>
            <section className="mb-4 sm:mb-6">
              <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-2 flex items-center gap-2 transition-all duration-200 hover:scale-105 hover:-translate-y-1 cursor-pointer">
                <i className="fas fa-info-circle" /> 服务简介
              </h2>
              <p className="text-gray-700 mb-2">
                <i className="fas fa-hand-point-right text-blue-500" /> 欢迎使用Happy文本转语音服务。我们的服务旨在便捷高效地将文字转换为语音，提升用户的听觉体验。
              </p>
            </section>
