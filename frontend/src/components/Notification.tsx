            ...
            <AnimatePresence>
                {notification && (
                    <motion.div
                        ...
                        className={`fixed top-4 right-4 z-[9999] ${getTypeStyles(notification.type)} text-white px-6 py-3 rounded-lg shadow-lg backdrop-blur-sm bg-opacity-95 flex items-center space-x-3`}
                    >
