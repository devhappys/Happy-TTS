              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-indigo-100 text-indigo-700 rounded hover:bg-indigo-200 transition-colors"
                  >
                    复制
                  </button>
                </div>
                ...
                {showBackupCodes && (
                  <div className="grid grid-cols-2 gap-2">
                    {setupData.backupCodes.map((code, index) => (
                      <code key={index} className="bg-white px-2 py-1 rounded text-xs font-mono text-center">
                        {code}
                      </code>
                    ))}
                  </div>
