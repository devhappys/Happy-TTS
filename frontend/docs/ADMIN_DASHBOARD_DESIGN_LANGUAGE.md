...
| Teal Blue | `#219EBC` | `[#219EBC]` | 次要强调色 / 信息图标 — 副标题文字、Hover 边框 |
...
| 横幅文字 | `text-white` | 头部横幅上的标题 |
| 横幅副文字 | `text-[#8ECAE6]` | 头部横幅上的副标题 |
...
5. 禁止横幅渐变 — 头部横幅使用纯色 `#023047`，保持视觉干净克制，避免过度装饰
