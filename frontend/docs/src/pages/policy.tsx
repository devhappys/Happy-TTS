...
export default function PolicyPage() {
  return (
    <Layout title="隐私政策与服务条款" description="Synapse API 文档站点服务条款与隐私政策">
        ...
        <div style={{ maxWidth: 800, width: '100%', background: '#fff', borderRadius: 18, boxShadow: '0 8px 32px rgba(99,102,241,0.10)', padding: 32 }}>
          ...
          <section style={{ marginBottom: 24 }}>
            ...
            <ul style={{ color: '#334155', paddingLeft: 24 }}>
              ...
              <li>如有疑问请联系：<a href="mailto:support@chloemlla.com" style={{ color: '#6366f1', fontWeight: 700 }}>support@chloemlla.com</a></li>
            </ul>
          </section>
          <section style={{ marginBottom: 24 }}>
          ...
          <section style={{ marginBottom: 24 }}>
            ...
            <div style={{ color: '#334155', fontSize: 16 }}>
              如有任何疑问、建议或投诉，请通过邮箱 <a href="mailto:support@chloemlla.com" style={{ color: '#6366f1', fontWeight: 700 }}>support@chloemlla.com</a> 联系我们。
            </div>
          </section>
