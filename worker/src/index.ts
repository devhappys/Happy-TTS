...
// 根路由
app.get("/", (c) => c.redirect("https://tts.951100.xyz/", 302));

// favicon
app.get("/favicon.ico", (c) =>
  c.redirect("https://picui.ogmua.cn/s1/2026/03/29/69c8f6226a17c.webp", 302)
);
...
// 健康检查
app.get("/health", (c) =>
  c.json({ status: "ok", runtime: "cloudflare-workers" })
);
