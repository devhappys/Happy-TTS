...
describe("Authentication Logic", () => {
  describe("Rate Limiting Behavior", () => {
    ...
    it("应该验证时间间隔检查逻辑", () => {
      ...
      const shouldCheckAuth = (timeSinceLastCheck: number, timeSinceLastError: number) => {
        return timeSinceLastCheck >= CHECK_INTERVAL && timeSinceLastError >= ERROR_RETRY_INTERVAL;
      };
