// OpenAPI/Swagger spec for /api/network utility endpoints (yiyan, douyinhot, hash, base64, bmi,
// flactomp3, jiakao). Collected by swagger-jsdoc via the `src/routes/**/*.ts` glob; no runtime code here.
