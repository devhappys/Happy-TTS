...
import { commandLimiter, logsLimiter } from "../middleware/routeLimiters";
...
router.get(
  ...
  adminLimiter,
  commandLimiter,
  DebugConsoleController.getEncryptedConfigs,
);
...
router.get(
  ...
  logsLimiter,
  logsReadLimiter,
  DebugConsoleController.getAccessLogs,
);
router.delete(
  "/logs/all",
  authenticateToken,
  ...
  logsLimiter,
  logsWriteLimiter,
  DebugConsoleController.deleteAllAccessLogs,
);
router.delete(
  "/logs/filter",
  authenticateToken,
  ...
  logsLimiter,
  logsWriteLimiter,
  DebugConsoleController.deleteAccessLogsByFilter,
);
router.delete(
  "/logs",
  authenticateToken,
  ...
  logsLimiter,
  logsWriteLimiter,
  DebugConsoleController.deleteAccessLogs,
);
router.delete(
  "/logs/:logId",
  authenticateToken,
  ...
  logsLimiter,
  logsWriteLimiter,
  DebugConsoleController.deleteAccessLog,
);
