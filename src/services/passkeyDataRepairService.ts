...
export class PasskeyDataRepairService {
  ...
  public static setLastStartPayload(payload: any) {
    PasskeyDataRepairService._lastStartPayload = payload;
  }

  public static setLastFinishPayload(payload: any) {
    PasskeyDataRepairService._lastFinishPayload = payload;
  }

  public static getLastPayloads() {
    return {
      start: PasskeyDataRepairService._lastStartPayload,
      finish: PasskeyDataRepairService._lastFinishPayload,
    };
  }
}
