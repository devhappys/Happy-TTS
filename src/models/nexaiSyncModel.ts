...
export const NexaiSyncModel = mongoose.models.NexaiSync || mongoose.model("NexaiSync", nexaiSyncSchema);
...
export type SyncCategory = "settings" | "notes" | "conversations" | "translations" | "passwords" | "shortUrls";
